...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=0.8\linewidth]{./results/gan/new_results/data_gan/samples_30000.png}
        \caption{Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=0.8\linewidth]{./results/gan/new_results/data_gan/interpolations_30000.png}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=0.8\linewidth]{./results/gan/new_results/data_ls_gan/samples_30000.png}
        \caption{Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=0.8\linewidth]{./results/gan/new_results/data_ls_gan/interpolations_30000.png}
        \caption{Latent Space Interpolations}
    \end{subfigure}
\end{figure}
...
\begin{figure}[H]
    \centering
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=0.8\linewidth]{./results/gan/new_results/data_wgan_gp/samples_30000.png}
        \caption{Samples}
    \end{subfigure}
    \begin{subfigure}[b]{0.32\linewidth}
        \includegraphics[width=0.8\linewidth]{./results/gan/new_results/data_wgan_gp/interpolations_30000.png}
        \caption{Latent Space Interpolations}
    \end{subfigure}
\end{figure}    
\end{questions}
