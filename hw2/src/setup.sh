...
mkdir /home/ubuntu/.local/lib/python3.8/site-packages/cleanfid/stats/
mkdir -p datasets/
...
cp cub_clean_custom_na.npz /home/ubuntu/.local/lib/python3.8/site-packages/cleanfid/stats/
